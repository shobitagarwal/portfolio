webpackJsonp([1, 0], [function(t, e, i) {
    ...
    t.exports = "<p class=about-description>Hello, My Name is Shobit Agarwal. I am currently associated with The LNM Institute of Information Technology, Jaipur (INDIA) and working under Prof. <i><a href=https://scholar.google.co.in/citations?user=_C6Ye5sAAAAJ&amp;hl=en target=_blank>Raghuvir Tomar</a></i>  <b>(Formerly with American/Canadian Hi-Tech Industry for Two Decades)</b>. My current work includes simulation and designing of Microstrip Antennas and Filters.<p class=about-description>During 8 years of academic life, I have handled several projects like Electronic Metal Detector, Microcontroller based clapper switch, Alcohol Detector Based Car Ignition System and many more. </p><div class=phone><img src=images/phone.png><p>+91-9694700700</p></div><div class=phone><img src=images/address.png><p>Room No. 1093, ECR Lab, LNMIIT, Jaipur, India</p></div>"
}, function(t, e) {
